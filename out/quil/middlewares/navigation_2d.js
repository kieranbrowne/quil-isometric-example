...
return cljs.core.merge.call(null,initial_state,p1__9409_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_9410 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_9411 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_9410);
var pos_9412 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_9410);
quil.core.scale.call(null,zoom_9411);

var tr__9332__auto___9413 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_9411) - cljs.core.first.call(null,pos_9412)),(((quil.core.height.call(null) / (2)) / zoom_9411) - cljs.core.second.call(null,pos_9412))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__9332__auto___9413);
