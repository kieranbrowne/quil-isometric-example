...
var vec__8881 = axis;
var a_x = cljs.core.nth.call(null,vec__8881,(0),null);
var a_y = cljs.core.nth.call(null,vec__8881,(1),null);
var a_z = cljs.core.nth.call(null,vec__8881,(2),null);
var vec__8884 = v;
var x = cljs.core.nth.call(null,vec__8884,(0),null);
var y = cljs.core.nth.call(null,vec__8884,(1),null);
var z = cljs.core.nth.call(null,vec__8884,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8887,p__8888){
var vec__8895 = p__8887;
var u1 = cljs.core.nth.call(null,vec__8895,(0),null);
var u2 = cljs.core.nth.call(null,vec__8895,(1),null);
var u3 = cljs.core.nth.call(null,vec__8895,(2),null);
var vec__8898 = p__8888;
var v1 = cljs.core.nth.call(null,vec__8898,(0),null);
var v2 = cljs.core.nth.call(null,vec__8898,(1),null);
var v3 = cljs.core.nth.call(null,vec__8898,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8901_SHARP_){
return (p1__8901_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8902_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8903_SHARP_,angle_lr),angle_ud);
...
var map__8910 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8910__$1 = ((((!((map__8910 == null)))?((((map__8910.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8910.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8910):map__8910);
var up = cljs.core.get.call(null,map__8910__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8910__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8912 = cljs.core._EQ_;
var expr__8913 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8912.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8913))){
return straight;
} else {
if(cljs.core.truth_(pred__8912.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8913))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8912.call(null,quil.middlewares.navigation_3d.space,expr__8913))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8912.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8913))){
return up;
} else {
if(cljs.core.truth_(pred__8912.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8913))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8912.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8913))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8910,map__8910__$1,up,straight){
return (function (p1__8904_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8904_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8910,map__8910__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8915_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8927_8938 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8927_8939__$1 = ((((!((map__8927_8938 == null)))?((((map__8927_8938.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8927_8938.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8927_8938):map__8927_8938);
var vec__8928_8940 = cljs.core.get.call(null,map__8927_8939__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8941 = cljs.core.nth.call(null,vec__8928_8940,(0),null);
var c_y_8942 = cljs.core.nth.call(null,vec__8928_8940,(1),null);
var c_z_8943 = cljs.core.nth.call(null,vec__8928_8940,(2),null);
var vec__8931_8944 = cljs.core.get.call(null,map__8927_8939__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8945 = cljs.core.nth.call(null,vec__8931_8944,(0),null);
var u_y_8946 = cljs.core.nth.call(null,vec__8931_8944,(1),null);
var u_z_8947 = cljs.core.nth.call(null,vec__8931_8944,(2),null);
var vec__8934_8948 = cljs.core.get.call(null,map__8927_8939__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8949 = cljs.core.nth.call(null,vec__8934_8948,(0),null);
var p_y_8950 = cljs.core.nth.call(null,vec__8934_8948,(1),null);
var p_z_8951 = cljs.core.nth.call(null,vec__8934_8948,(2),null);
quil.core.camera.call(null,p_x_8949,p_y_8950,p_z_8951,(p_x_8949 + c_x_8941),(p_y_8950 + c_y_8942),(p_z_8951 + c_z_8943),u_x_8945,u_y_8946,u_z_8947);
